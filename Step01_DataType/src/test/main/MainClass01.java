 ...
 *  
 *  1. 숫자형 (8가지 중 6개) 
 *           사용 가능한 범위에 따라서 세부적으로 사용 가능 (숫자 범위가 다 다름)
 *  
...
public class MainClass01 {
	...
	public static void main(String[] args) {
		...
		int tmp=iShort;  // iByte, iShort, iInt 다 가능 : int타입 범위가 훨씬 더 큼 / iLong은 안됨
		
		/*
		 * 표현 가능한 범위가 더 넓은 변수에 담긴 내용을 대입하려면
		 * 명시적으로 casting을 해야 한다.
		 */
		byte tmp2=(byte)iInt;  // (type) : casting operator(성변환 연산자), 원래는 성립 안하지만 범위 안에 담긴 값이 작다면 성립하게 할 수 있음(프로그래머의 판단 하에 안넘치는게 확실하다면)
