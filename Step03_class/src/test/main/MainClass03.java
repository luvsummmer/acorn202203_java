package test.main;
/*
 * 한 명의 회원 정보를 담을 수 있는 객체를 생성할 Member 클래스를
...
public class MainClass03 {
	public static void main(String[] args) {
		// 2. Member 클래스로 객체를 생성(=new)해서 참조값을 m1이라는 지역변수에 담아보세요.
		Member m1=new Member();  // 적는 순서 우측부터임
		...
		/*
		 * 위와 비슷한 작업을 javascript로 한다면? (너무편함 ㅋㅋ)
		 * 
		 * let m1={};
		 * m1.num=1;
		 * m1.name="김구라";
		...
		// 참조해서 필드에 값을 넣을 수도 있고 필드값을 읽어올 수도 있다 !
	}
}
